                    ...
                    <form action="" method="post" className="section__settings">
                        <div className="wrapper-card">
                            <fieldset className="fieldset__settings">
                                ...
                                <DesignForm changeColor={this.props.changeColor} collapsibleValue={this.props.collapsibleValue}/>
                            </fieldset>
                            <fieldset className="fieldset__settings">
                                <div className="settings__fill section__fieldset">
                                    ...
                                    <FillForm actionToChange={this.props.actionToChange} collapsibleValue={this.props.collapsibleValue}/>
                                </div>
                            </fieldset>
                            <fieldset className="fieldset__settings">
                                <div className="share__design section__fieldset hidden__collapsible">
                                    ...
                                    <ShareForm actionToChange={this.props.actionToChange} collapsibleValue={this.props.collapsibleValue} />
                                </div>
                            </fieldset>
                        </div>
                    </form>
