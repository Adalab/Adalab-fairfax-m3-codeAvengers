                ...
                <div>
                    <form action="" method="post" className="section__settings">
                        <div className="wrapper-card">
                            ...
                            <div className={`settings__design section__fieldset ${this.props.collapsibleValue.design === true ? '' : 'hidden__collapsible'}`}>
                            ...
                            <fieldset className="fieldset__settings">
                                <div className={`settings__fill section__fieldset ${this.props.collapsibleValue.fill === true ? '' : 'hidden__collapsible'}`}>
                            ...
                            <fieldset className="fieldset__settings">
                                <div className={`share__design section__fieldset  ${this.props.collapsibleValue.share === true ? '' : 'hidden__collapsible'}`}>
