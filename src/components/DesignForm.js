            ...
            <div id="design-container" className="design__container--palette collapsible__container">
                ...
                <div> <a href="true" className="design__palette-colors">
                    <label className="design__palette palette1" htmlFor="settings__palette1">
                        <input className="desidn__radio" value="1" type="radio" id="settings__palette1" name="color" onChange={this.props.changeColor} checked={this.props.palette === 1 ? true : false} />
                    ...
                    <a href="true" className="design__palette-colors">
                        <label className="design__palette palette2" htmlFor="settings__palette2">
                            <input className="desidn__radio" type="radio" id="settings__palette2" value="2" name="color" onChange={this.props.changeColor} checked={this.props.palette === 2 ? true : false}/>
                            <ul className="design__list">
                    ...
                    <a href="true" className="design__palette-colors">
                        <label className="design__palette palette3" htmlFor="settings__palette3">
                            <input className="desidn__radio" value="3" type="radio" id="settings__palette3" name="color" onChange={this.props.changeColor} checked={this.props.palette === 3 ? true : false}/>
                            <ul className="design__list">
