        ...
        <div className="landing__subwrapper">
          ...
          <main className="landing__main">
            <div className="wrapper">
              ...
              <h3 className="landing__main--description">Crea mejores contactos profesionales de forma fácil y cómoda</h3>
              <ul className="landing__list">
                <li className="landing__list--item">
                  <div className="landing__list--img"><i className="far fa-object-ungroup"></i>
                  </div>
                  <p className="landing__list--text">Diseña</p>
                </li>
                <li className="landing__list--item">
                  <div className="landing__list--img"><i className="far fa-keyboard"></i>
                  </div>
                  <p className="landing__list--text">Rellena</p>
                </li>
                <li className="landing__list--item">
                  <div className="landing__list--img"><i className="fas fa-share-alt"></i>
                  </div>
                  <p className="landing__list--text">Comparte</p>
                </li>
              </ul>
              <div className="landing__main--link-container"> <a href="card.html" className="landing__main--link">Comenzar</a>
              </div>
            </div>
          </main>
        </div>
